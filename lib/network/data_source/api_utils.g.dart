...
class _PostApi implements PostApi {
  ...
  @override
  Future<CustomerResponse> getCustomers(LoginRequestModel request) async {
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/AndroidService.svc/GetCustomers',
  ...
  @override
  Future<CategoryResponse> getCategories(LoginRequestModel request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/AndroidService.svc/GetCategories',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<ProductsResponse> getProducts(LoginRequestModel request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/AndroidService.svc/GetProducts',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
